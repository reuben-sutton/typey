...
pub(crate) fn check_with_policies(
    ...
    let analyzer = Analyzer {
        ...
        method_resolution_cache: RefCell::new(CowState::new(HashMap::new())),
...
struct Analyzer<'src> {
    ...
    method_resolution_cache: RefCell<CowState<HashMap<MethodKey, Option<MethodKey>>>>,
...
pub(super) struct CfgTransferSnapshot {
    ...
    collect_method_definitions: bool,
    skip_root_method_definitions: bool,
    method_resolution_cache: CowState<HashMap<MethodKey, Option<MethodKey>>>,
